...
During this first week, it will be important to start getting comfortable with a couple of the tools we will use for the course. 
...
✔️ Visit the [course repo on Github](https://github.com/cmadland/edci338-202201) and create a `Learner Profile` issue.  
