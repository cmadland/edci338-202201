...
`![Ellie with a cactus in her nose](_assets/poor-ellie.jpg)` renders to

![Ellie with a cactus in her nose](_assets/poor-ellie.jpg)

The difference with images is that you need to make sure the image is physically in the same repository that you are working in. In this case, the image is in the `docs/_assets` folder.
...
✔️ Click `Issues`, then `New Issue`, then `Get Started` on a Learner Profile for yourself.  
```
